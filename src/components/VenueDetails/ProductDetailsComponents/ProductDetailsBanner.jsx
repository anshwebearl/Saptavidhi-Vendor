...
function ProductDetailsBanner({
    ...
    return (
        <div className="border-2 rounded-[30px] shadow-lg overflow-hidden">
            ...
            <div className="md:px-6 md:py-6 px-4 py-5 flex flex-col gap-3 md:flex-row justify-between">
        ...
        <div className="fixed inset-0 flex items-center justify-center z-50 bg-black bg-opacity-50 w-full">
            <div className="bg-white rounded-lg shadow-lg w-[90%] md:w-[500px] flex flex-col">
                <div className="bg-[#CF166F1A] px-3 py-2 md:px-6 md:py-3 flex justify-between items-center">
                    <h2 className="text-lg md:text-2xl font-bold text-[#CF166F]">Contact Information</h2>
                    <button
                ...
                <div className="flex flex-col gap-3  px-6 py-3 ">
                    <div>
                        <div className="flex items-center gap-2">
                            ...
                            <p className="text-[#CF166F] font-[500] md:text-lg text-base">Email</p>
                        </div>
                        <p className="text-gray-600 font-[600] ml-3">{email}</p>
                    </div>
                    <div>
                        <div className="flex items-center gap-2">
                            <PiPhoneDisconnectBold color={"#CF166F"} size={24}/>
                            <p className="text-[#CF166F] font-[500] md:text-lg text-base">Phone</p>
                        </div>
                    ...
                    <div>
                        ...
                        <p className="text-gray-600 font-[600] ml-3">{address}</p>
                    </div>
                </div>
            </div>
        </div>
