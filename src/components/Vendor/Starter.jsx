  ...
  return (
    <div className="bg-white border border-pink-400 rounded-lg p-4 md:p-6 flex flex-col items-center gap-5 w-60 flex-grow">
      <div className="bg-[#FF6B85] rounded-t-lg py-3 md:py-4 px-20 flex justify-center items-center gap-2.5">
        <span className="text-white font-medium text-lg  md:text-2xl">Starter</span>
      </div>
      <div className="flex flex-col items-center gap-2.5">
        <span className="text-[#FF6B85] text-medium text-center">₹ 97000 / Yearly +18% taxes extra</span>
        <div className="bg-[#FF6B85] rounded-full py-1.25 px-5 flex items-center gap-4">
